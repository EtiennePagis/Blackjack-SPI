...
/**
*\fn donner_valeur_carte(short joueur,short carte)
*\brief prend le numero de carte entre 0 et 51 et retourne sa valeur cette fonction devra incrementer nb_as_joueur ou nb_as_banque
*/
